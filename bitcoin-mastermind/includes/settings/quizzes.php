...
if (!defined('HDQ_EDIT_AUTHORED')) {
	...
	?>
				<div class='notice notice-success is-dismissible'>
					<p>Thank you for upgrading Bitcoin Mastermind to v<?php echo HDQ_PLUGIN_VERSION; ?>. <strong style="font-weight: bold">This version requires updating your quiz and question data to be compatible with this version.</strong></p>
