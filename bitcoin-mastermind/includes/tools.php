...
<div id="main" style="max-width: 800px; background: #f3f3f3; border: 1px solid #ddd; margin-top: 2rem">
	...
	<p>Bitcoin Mastermind has grown considerably in features and complexity over the years making this page necessary. Most of you
		...
		<div>
			...
			<div class="hdq_accordion">
				...
				<div style="display: none;">
					<p>
						Since Bitcoin Mastermind 1.8, quiz and question data is saved and retrieved in a completely new way. For
						those of you with less than 200 questions on your site, the data migration and upgrade should
						have happened automatically when you upgraded Bitcoin Mastermind.
					</p>
					<p>
