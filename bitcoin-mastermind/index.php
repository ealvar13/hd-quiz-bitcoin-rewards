...
function hdq_create_settings_page()
{
    if (hdq_user_permission()) {
        ...
        {
            add_menu_page('Bitcoin Mastermind', 'Bitcoin Mastermind', 'publish_posts', 'hdq_quizzes', 'hdq_register_quizzes_page_callback', 'dashicons-clipboard', 5);
            add_menu_page('Bitcoin Mastermind Addons', 'HDQ Addons', 'edit_posts', 'hdq_addons', 'hdq_register_addons_page_callbak', '', 99);
            add_menu_page('Bitcoin Mastermind Tools', 'HDQ Tools', 'edit_posts', 'hdq_tools', 'hdq_register_tools_page_callbak', '', 99);

            add_menu_page('Bitcoin Mastermind Tools - CSV Importer', 'HDQ Tools CSV', 'edit_posts', 'hdq_tools_csv_importer', 'hdq_register_tools_csv_importer_page_callback', '', 99);
            add_menu_page('Bitcoin Mastermind Tools - Data Upgrade', 'HDQ Tools DATA', 'edit_posts', 'hdq_tools_data_upgrade', 'hdq_register_tools__data_upgrade_page_callback', '', 99);
        ...
        function hdq_register_settings_page()
        {
            ...
            add_submenu_page('hdq_quizzes', 'Bitcoin Mastermind About', 'About / Options', 'publish_posts', 'hdq_options', 'hdq_register_settings_page_callback');
