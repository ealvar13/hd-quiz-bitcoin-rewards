...
if (isset($_POST['bitc_rewards_save'])) {
    $bitc_nonce = isset($_POST['bitc_rewards_nonce']) ? $_POST['bitc_rewards_nonce'] : null;

    // Check if nonce is valid
    if ($bitc_nonce && wp_verify_nonce($bitc_nonce, 'bitc_rewards_nonce')) {
        ...
        wp_die('Nonce verification failed for Rewards Settings.');
    }
}
